...
export default function Register() {
  ...
  const formContent = registerSuccess.get()
    ...
    : form({
        ...
        inputL("username", "username", "USERNAME", "text", username.get(), (e) => username.set((e.target as HTMLInputElement).value), "username", UserIconSVG),
        inputL("email", "email", "EMAIL", "email", email.get(), (e) => email.set((e.target as HTMLInputElement).value), "user@example.com", UserIconSVG),
        inputL("password", "password", "PASSWORD", "password", password.get(), (e) => password.set((e.target as HTMLInputElement).value), "********", LockIconSVG),
        inputL("confirmPassword", "confirmPassword", "CONFIRM PASSWORD", "password", confirmPassword.get(), (e) => confirmPassword.set((e.target as HTMLInputElement).value), "********", LockIconSVG),
  ...
  // prettier-ignore
  return TerminalBox("terminal@user:~/auth/register",
