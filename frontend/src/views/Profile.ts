import { div, p, form, input, label, span, img } from '@framework/tags';
	...
	return div(
		...
		form(
			...
			inputL(
				...
				'email',
				email.get,
				e => email.set((e.target as any)?.value),
				'email@example.com',
				EmailIconSVG
			),
			inputL(
				...
				'tel',
				phone.get,
				e => phone.set((e.target as any)?.value),
				'+1234567890',
				PhoneIconSVG
			),
			textareaL(
				...
				'BIO',
				bio.get,
				e => bio.set((e.target as any)?.value),
